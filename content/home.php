...
<body>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            ...
            <h1 class="text-white display-3 mb-5">Bengkel Motor Jaya</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 pb-4 pb-lg-0">
                    ...
                    <div class="bg-primary text-dark text-center p-4">
                        <h3 class="m-0">Bengkel Motor Jaya</h3>
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <p class="mb-4">Sepeda motor kini bukan hanya menjadi sarana transportasi produktif bagi masyarakat
                        ...
                        membanggakan. Untuk
                        menemani masyarakat beraktivitas dan menggapai beragam mimpinya, Bengkel Motor Jaya
                    ...
                    <div class="bg-secondary" style="padding: 30px;">
                        <div class="d-flex mb-3">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle" style="width: 40px; height: 40px;" src="asset/img/user.jpg"
                                    alt="">
